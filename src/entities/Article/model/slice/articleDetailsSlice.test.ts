...
describe("articleDetailsSlice.test", () => {
  test("test article daetails service pending", () => {
    ...
    const pendingAction = {
      type: "articleDetails/fetchArticleById/pending",
      meta: {
    ...
    expect(
      articleDetailsReducer(state as ArticleDetailsSchema, pendingAction)
    ).toEqual({
      isLoading: true,
      error: undefined,
    });
  ...
  test("test article daetails service fulfilled", () => {
    const state: DeepPartial<ArticleDetailsSchema> = {
      isLoading: true,
    };
    ...
    expect(
      articleDetailsReducer(state as ArticleDetailsSchema, fulfilledAction)
    ).toEqual({
      isLoading: false,
      data: data,
    });
  ...
  test("test article daetails service rejected", () => {
    const state: DeepPartial<ArticleDetailsSchema> = {
      isLoading: true,
    };
